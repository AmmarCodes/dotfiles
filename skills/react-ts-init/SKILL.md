...
- User wants strict TypeScript + ESLint + Prettier setup
...
- `configs/prettier.config.js` - Prettier with import organization and Tailwind CSS
...
### 6. Run initial lint fix and format
...
Both should pass without errors on a fresh project scaffolding.
